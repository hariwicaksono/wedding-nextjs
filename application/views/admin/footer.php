                    ...
                    columns: [
                        ...
                        {"data": "nohp",
                            "render": function ( data, type, row ) {
  							return '<a data-id="'+row.id+'" onclick="kirim_wa()" id="kirim" href="https://web.whatsapp.com/send?phone='+row.nohp+'?text='+baseUrl+'/confirm/u/' + row.id + '" alt="Kirim WA" title="Kirim WA" uk-tooltip="Kirim WA" target="_blank">'+row.nohp+'</a>';
								}
                        },

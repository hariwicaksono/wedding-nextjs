...
class Pengaturan extends Component {
    ...
    render() {
        ...
        <img className="img-fluid mt-3 mb-3" width="600" src={this.state.url+res.foto} alt='' style={{border: '28px solid transparent',WebkitBorderImage: "url('/images/border-image-6.svg') 30 35 stretch"}}/>
